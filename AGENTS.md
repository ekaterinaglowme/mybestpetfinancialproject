...
- Мёрж-коммиты запрещены. Всегда использовать rebase: `git rebase origin/main`
- На GitHub в настройках репо включён только "Allow rebase merging" — merge commits и squash отключены
